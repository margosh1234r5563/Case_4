...
for s in range(len(cost_items)):
    while money >= amnt_mny_itms:
        ...
        result_1 = None if money >= amnt_mny_itms else print(f'{amnt_mny_itms} > {money}')
        break
    else:
        phase +=1
result_2 = print(f'{ru.OFFENCE}. Деньги закончились еще на {phase})') if result_1 != None
...
amnt_mny_itms_final += cost_drink
